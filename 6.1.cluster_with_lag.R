...
iterations = 5
averaged.rand.index = list(0, 0, 0)
averaged.adjusted.rand.index = list(0, 0, 0)
inertia = list(0, 0, 0)
...
# Reset Dates
for(pseudofold in 1:iterations) {
  print(pseudofold)
  rm("selected")
  rm("true.groups")
  rm("gerp.affinity")
  ...
  tryCatch({
    ...
    averaged.rand.index[[1]] <- averaged.rand.index[[1]] + fossil::rand.index(as.integer(ground.truth), as.integer(clusters$cluster))
    averaged.adjusted.rand.index[[1]] <- averaged.adjusted.rand.index[[1]] + adjusted.rand.index(as.integer(ground.truth), as.integer(clusters$cluster))
    inertia[[1]] <- inertia[[1]] + clusters$tot.withinss
    
    clusters <- kernlab::specc(gerp.affinity, centers)
    averaged.rand.index[[2]] <- averaged.rand.index[[2]] + fossil::rand.index(as.integer(ground.truth), as.integer(clusters))
    averaged.adjusted.rand.index[[2]] <- averaged.adjusted.rand.index[[2]] + adjusted.rand.index(as.integer(ground.truth), as.integer(clusters))
    inertia[[2]] <- inertia[[2]] + sum(cluster.inertias(clusters, selected[, -1]))
    
    clusters <- kernlab::specc(corr.affinity, centers)
    averaged.rand.index[[3]] <- averaged.rand.index[[3]] + fossil::rand.index(as.integer(ground.truth), as.integer(clusters))
    averaged.adjusted.rand.index[[3]] <- averaged.adjusted.rand.index[[3]] + adjusted.rand.index(as.integer(ground.truth), as.integer(clusters))
    inertia[[3]] <- inertia[[3]] + sum(cluster.inertias(clusters, selected[, -1]))
...
print(paste("KMEANS fossil rand index:", averaged.rand.index[[1]]/iterations))
print(paste("KMEANS adj rand index:", averaged.adjusted.rand.index[[1]]/iterations))
print(paste("KMEANS Inertia:", inertia[[1]]/iterations))
print(paste("GERP fossil rand index:", averaged.rand.index[[2]]/iterations))
print(paste("GERP adj rand index:", averaged.adjusted.rand.index[[2]]/iterations))
print(paste("GERP Inertia:", inertia[[2]]/iterations))
print(paste("CORR fossil rand index:", averaged.rand.index[[3]]/iterations))
print(paste("CORR adj rand index:", averaged.adjusted.rand.index[[3]]/iterations))
print(paste("CORR Inertia:", inertia[[3]]/iterations))
